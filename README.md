...
### Conclusion
While the results are sasitfactory for the first track, the car is not able to successfully run in the jungle track. My plan is to revisit this project to find a solution for the second track. Furthermore, training a deep reinforcement agent would be an intresting future direction.
